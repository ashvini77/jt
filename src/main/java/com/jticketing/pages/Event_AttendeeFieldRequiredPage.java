...
public class Event_AttendeeFieldRequiredPage extends TestBase{
	
CreateEventPage event = new CreateEventPage(driver);
	
	public void CreateEventWithAttendeeFieldRequired(String eventtitle, String eventstartdate, String eventenddate,
		...
		logger.pass("Event has created successfully with attendee field is required");
	}
