...
public class UnlimitedSeatsEventPage extends TestBase{

	public UnlimitedSeatsEventPage(WebDriver driver) {
		super();
	}
	...
	public void CreateEventWithUnlimitedSeats(String eventtitle, String eventstartdate, String eventenddate, String eventimage,
	    ...
	    SelectDropdownValue(event.FirstTicketSeatsAvailability, event.FirstTicketUnlimitedSeats);
	    ScrollDown4();
		...
		logger.pass("Unlimited seats event has created successfully");
	}
