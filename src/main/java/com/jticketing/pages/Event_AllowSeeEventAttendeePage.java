...
public class Event_AllowSeeEventAttendeePage extends TestBase{
	
CreateEventPage event = new CreateEventPage(driver);
	
	public void CreateEventWithAllowSeeEventAttendee(String eventtitle, String eventstartdate, String eventenddate,
		...
		logger.pass("Event has created successfully with access to see event attendee");
	}
