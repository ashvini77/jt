...
public class LimitedSeatsEventPage extends TestBase{

	public LimitedSeatsEventPage(WebDriver driver) {
		super();
	}
	...
	public void CreateEventWithLimitedSeats(String eventtitle, String eventstartdate, String eventenddate, String eventimage,
			...
			String firstticketprice, String firstticketenddate, String seatscount, String firstattendeefieldtitle) throws InterruptedException {
	    ...
	    EnterValue(event.FirstTicketSeatsCount, seatscount);
	    ScrollDown4();
		...
		logger.pass("Limited seats event has created successfully");
