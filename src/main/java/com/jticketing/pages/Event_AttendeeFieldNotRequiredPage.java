...
public class Event_AttendeeFieldNotRequiredPage extends TestBase{

CreateEventPage event = new CreateEventPage(driver);
	
	public void CreateEventWithAttendeeFieldNoTRequired(String eventtitle, String eventstartdate, String eventenddate,
		...
		ScrollDown2();
		SelectDropdownValue(event.SelectFirstAttendeeFieldRequired, event.FirstAttendeeFieldRequiredNo);
		ScrollUp3();
		ButtonClick(event.SaveandClose);
		logger.pass("Event has created successfully with attendee field is not required");
	}
